...
<tbody>
<tr>
<td><img src="resources/images/close/${list.prodCode}.jpg" width="120px" height="110px"></td>
<td>${list.prodName}</td>
<td>${list.size}</td>
<td>${list.color}</td>
<td>${list.count}</td>
...
<input type="button" class="btn btn-primary" onclick="execDaumPostcode()" value="우편번호찾기">
...
<input type="hidden" value="주문" name="orderStatus"> 
<input name="custId" type="hidden" size="20" value="${sessionScope.userInfo.id }">
<div class="col-sm-3" style="text-align:center;">
<input type="submit" class="btn btn-light btn-lg btn btn-primary" value="결제하기">
<button type="button" class="btn btn-light btn-lg btn btn-primary" onclick="location.href = 'index.do'">주문취소</button>
</div>
</form>
