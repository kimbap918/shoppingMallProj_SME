...
<body>
				...
				<tbody>
					...
					<tr>
						<td><input type="text" id="addr4" name="addr4" size=5
							...
							<br>도로 주소:<input type="text" id="addr" name="addr" size="50"
							value="${sessionScope.userInfo.addr }"> <br>지번 주소:<input
							...
							value="${sessionScope.userInfo.addr5 }"> <br>상세 주소:
	...
	가장 처음 상태인 배송준비 상태이므로 값을 0으로 히든타입으로 해서 보낸다. -->
			<input type="hidden" value="0" name="shipStat"> <input
