		...
		<form role="form" method="get" name="boardForm" action="boardwrite.do">
			...
			<div class="form-group">
				...
				<textarea style="resize: none;" class="form-control" id="content"
					name="content" rows="5" cols="3"></textarea>
			</div>

			<div class="form-group">
				<label class="col-sm-2 control-label" for="writer">작성자</label> <input
					class="form-control" type="text" id="writer" name="writer"
					value="${sessionScope.userInfo.name}" readonly>

			</div>
			<div class="form-group">
				<input class="boardwrite_btn btn-primary" type="button"
					id="submitBtn" value="작성하기">
